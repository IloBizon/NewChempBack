# Generated by Django 6.0.1 on 2026-02-03 07:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=12, validators=[app.models.validate_pass])),
                ('login_attempts', models.SmallIntegerField(default=0)),
                ('disease', models.CharField(max_length=123)),
                ('height', models.IntegerField(validators=[app.models.validate_height])),
                ('weight', models.IntegerField(validators=[app.models.validate_weight])),
